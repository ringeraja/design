...
const newObject = {} as Propstype;

newObject.title = 'New Title';
newObject.linkto = '/new-link';
...
.btn {
  ...
  background-image: linear-gradient(#21212120, #220fcd39),
    linear-gradient(137.48deg, #3bff72 10%, #0d41ffd7 45%, #54ff41 67%, #79ff3fd7 87%);
